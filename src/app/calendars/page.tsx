  ...
  return (
    <>
      ...
      <div style={centeredStyle}>
        ...
        >
          <Form
            onFinish={handleSubmit((data) => handleSaveClick(data))}
            style={{ marginTop: '30px' }}
          >
            <Row gutter={16}>
              <Col span={20}>
                <FormItem label="Title" name="title" control={control}>
                  <Input placeholder="title" />
                </FormItem>
              </Col>
              <Col span={20} style={{ marginTop: '20px' }}>
                <FormItem label="Start" name="start" control={control}>
                  <Controller
                    control={control}
                    name="start"
              ...
              <Col span={20} style={{ marginTop: '20px' }}>
                <FormItem name="end" label="End" control={control}>
                  <Controller
                    control={control}
                    name="end"
                    render={({ field: { onChange, value, ...rest } }) => (
              ...
              <Col span={20} style={{ marginTop: '20px' }}>
                <FormItem name="backgroundColor" label="Background Color" control={control}>
              ...
              <Col span={20} style={{ marginTop: '20px' }}>
                <FormItem name="borderColor" label="Border Color" control={control}>
                  <Select placeholder="select a color">
                    <Select.Option value="red">Red</Select.Option>
                    <Select.Option value="blue">Blue</Select.Option>
                    <Select.Option value="green">Green</Select.Option>
